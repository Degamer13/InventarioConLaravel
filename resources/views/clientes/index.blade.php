                ...
                @foreach ($clientes as $cliente)
                    <tr>
                        ...
                        <td class="text-center">
                            @can('cliente-show')
                                <a href="{{ route('clientes.show', $cliente->id) }}" class="btn btn-info"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                            ...
                            @can('cliente-edit')
                                <a href="{{ route('clientes.edit', $cliente->id) }}" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
