...
<div class="container">
    ...
    <form method="GET" action="{{ route('totales.compras') }}" class="mb-4">
        <div class="row">
            <div class="col-md-4">
   ...
   <h3>Bs. {{ number_format($totalBolivares, 2, ',', '.') }}</h3>
    ...
    <a href="{{ route('compras.index') }}" class="btn btn-secondary mt-3">Volver a la lista de compras</a>
</div>
@endsection
