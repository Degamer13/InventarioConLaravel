                ...
                <div class="product-row mb-3">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select name="productos[{{ $index }}][producto_id]" class="form-control product-select select2" required>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="productos[{{ $index }}][cantidad]" class="form-control cantidad-input" 
                            placeholder="Cantidad" required min="1" value="{{ $producto->pivot->cantidad }}">
                        </div>
                        <div class="col-md-3">
                            <label for="total">Total Producto</label>
                            <p class="product-total">Total Producto: <span class="product-total-price">
                                {{ number_format($producto->pivot->total, 2) }}</span> Bs</p>
                            <input type="hidden" name="productos[{{ $index }}][total]" class="total-input" 
                            value="{{ $producto->pivot->total }}">
                        </div>
                    </div>
                </div>
            @endforeach
...
<script>
    let productosCount = {{ count($venta->productos) }};
