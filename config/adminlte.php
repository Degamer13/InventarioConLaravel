...
return [
    ...
    */
    ...
    'menu' => [
      ...
      [
    'header' => 'Manajadores de Usuarios',
],
[
    'text' => 'Usuarios',
    'url' => 'users',
    'icon' => 'fas fa-fw fa-users',
    'can' => 'user-list',  // Verificar si el usuario tiene el permiso 'user-list'
],
[
    'text' => 'Roles',
    'url' => 'roles',
    'icon' => 'fas fa-fw fa-user-shield',
    'can' => 'role-list',  // Verificar si el usuario tiene el permiso 'role-list'
],
[
    'text' => 'Permisos',
    'url' => 'permissions',
...
[
    ...
    'submenu' => [
        [
            ...
            'can' => 'dolar-list',  // Verificar si el usuario tiene el permiso 'dolar-list'
        ],
        [
            'text' => 'Categorías',
            'url' => 'categorias',
            'icon' => 'fas fa-th-list',
            'can' => 'categoria-list',  // Verificar si el usuario tiene el permiso 'categoria-list'
        ],
        [
            'text' => 'Clientes',
            'url' => 'clientes',
        ...
        ['header' => 'Estadistica'],
         [
            ...
            'can' => 'total-venta',  // Verificar si el usuario tiene el permiso 'total-venta'
        ],
         [
            'text' => 'Total De Compras',
            'url' => 'totales/compras',
            'icon' => 'fas fa-chart-line',
          'can' => 'total-compra',  // Verificar si el usuario tiene el permiso 'total-venta'
        ],
       /* [
            'text' => 'warning',
            'icon_color' => 'yellow',
